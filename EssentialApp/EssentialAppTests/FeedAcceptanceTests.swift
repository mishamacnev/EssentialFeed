...
class FeedAcceptanceTests: XCTestCase {
    ...
    private func makeData(for url: URL) -> Data {
        ...
        case "/essential-feed/v1/feed" where url.query?.contains("after_id=2AB2AE66-A4B7-4A16-B374-51BBAC8DB081") == true:
    ...
    private func makeSecondFeedPageData() -> Data {
        return try! JSONSerialization.data(withJSONObject: ["items": [
            ["id": "2AB2AE66-A4B7-4A16-B374-51BBAC8DB081", "image": "http://feed.com/image-2"]
        ]])
    }
