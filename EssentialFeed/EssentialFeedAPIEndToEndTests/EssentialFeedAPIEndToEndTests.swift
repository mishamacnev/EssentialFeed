...
//
//  Created by Mihail on 07.04.2021.
//
...
class EssentialFeedAPIEndToEndTests: XCTestCase {
    ...
    func test_endToEndTestServerGetFeedResult_matchesFixedTestAccountData() {
        ...
        case .success(let imageFeed)?:
            XCTAssertEqual(imageFeed.count, 8, "expected 8 images in the test account imagge feed")
        ...
        default:
            XCTFail("expected success result, got no result instead")
        }
    }
